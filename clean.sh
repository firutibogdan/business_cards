...
interface_msg=$(docker container ls -a | grep "business_cards_interface_msg" | sed 's/  */ /g' | cut -d' ' -f1)
interface=$(docker container ls -a | grep "business_cards_interface " | sed 's/  */ /g' | cut -d' ' -f1)
advertise=$(docker container ls -a | grep "business_cards_advertise" | sed 's/  */ /g' | cut -d' ' -f1)
...
interface_msg=$(docker image ls -a | grep "business_cards_interface_msg" | sed 's/  */ /g' | cut -d' ' -f3)
interface=$(docker image ls -a | grep "business_cards_interface " | sed 's/  */ /g' | cut -d' ' -f3)
advertise=$(docker image ls -a | grep "business_cards_advertise" | sed 's/  */ /g' | cut -d' ' -f3)
