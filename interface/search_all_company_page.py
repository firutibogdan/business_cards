...
def get_html(admin, persons):
	...
	for person in persons:
		...
		if admin:
			text += '''
				<td><br><button onclick="location.assign('edit_c_info?name={}');" class="button2"></button><br><br></td>
          		<td><br><button onclick="location.assign('delete_c_info?name={}');" class="button3"></button><br><br></td>
			'''.format(person[0], person[0])
